...
const GenerateIssuedForDyingGroupsReport = async (details) => {
  ...
  const filePath =
    "public/reports/NewRport/IssuedForDyingGroupsReportExcel/issue_for_dying_groups_reports.xlsx";
  ...
  const downloadFileName = `issue_for_dying_groups_reports${timestamp}.xlsx`;

  // Move the file to the desired folder
  const destinationPath = `public/reports/NewRport/IssuedForDyingGroupsReportExcel/${downloadFileName}`;
...
export { GenerateIssuedForDyingGroupsReport };
