...
const GenerateIssueCuttingReport = async (details) => {
    ...
    details.forEach((cutting) => {
        cutting?.cutting_item_details?.forEach((itemData) => {
            const row = worksheet.addRow({
                ...
                physical_location: cutting?.group_history_id?.group_id?.group_physical_location,
    ...
    const filePath = "public/reports/Cutting/IssueForCuttingReportExcel/issue_for_cutting_report.xlsx";
