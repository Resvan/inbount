...
const GenerateCuttingReport = async (details) => {
    ...
    const headers = [
        ...
        { header: "Total Item Sqm Avl", key: "total_item_sqm_available", width: 15 },
        ...
        { header: "No. Of Pattas", key: "cutting_no_of_pattas", width: 15 },
    ...
    details.forEach((cutting) => {
        cutting?.group_history_id?.cutting_item_details?.forEach((itemData,index) => {
            const row = worksheet.addRow({
                ...
                group_no_of_pattas_available: cutting?.group_history_id?.group_id?.group_no_of_pattas_available,
                group_no_of_peices: cutting?.group_history_id?.group_id?.group_pcs,
                group_sqm_available: cutting?.group_history_id?.group_id?.group_sqm_available,
                total_item_sqm_available: cutting?.group_history_id?.group_id?.total_item_sqm_available,
                ...
                group_pallete_no: cutting?.group_history_id?.group_id?.group_pallete_no,
                group_physical_location: cutting?.group_history_id?.group_id?.group_physical_location,
                ...
                cutting_no_of_pattas: cutting?.item_details?.[index]?.cutting_no_of_pattas,
    ...
    const filePath = "public/reports/Cutting/CuttingReportExcel/cutting_report.xlsx";
