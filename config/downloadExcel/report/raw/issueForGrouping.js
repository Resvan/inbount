...
const GenerateIssueForGroupingReport = async (details) => {
  ...
  const downloadFileName = `issue_for_grouping_report${timestamp}.xlsx`;

  // Move the file to the desired folder
  const destinationPath = `public/reports/Raw/issueForGroupingReportExcel/${downloadFileName}`;
...
export { GenerateIssueForGroupingReport };
